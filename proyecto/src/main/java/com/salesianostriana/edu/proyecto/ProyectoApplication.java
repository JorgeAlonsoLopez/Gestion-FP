...
//			ampliacionServicio.nuevaAmpliacion("alumno2@email.com", "2º DAM", "Sistemas de Gestión Empresarial");
				...
				Excepcion ex = new Excepcion(pk, alumnoServicio.findById(25L), asignaturaServicio.findById(3L), LocalDate.now(), "Conv", "Pendiente");
				excepcionServicio.save(ex);
				ExcepcionPK pk2 = new ExcepcionPK(28L, 6L);
				Excepcion ex2 = new Excepcion(pk2, alumnoServicio.findById(28L), asignaturaServicio.findById(6L), LocalDate.now(), "Excep", "Pendiente");
				excepcionServicio.save(ex2);
				AmpliacionPK pk3 = new AmpliacionPK(30L,10L);
				AmpliacionPK pk4 = new AmpliacionPK(32L,11L);
				Ampliacion am1 = new Ampliacion(pk3, alumnoServicio.findById(30L), asignaturaServicio.findById(10L), LocalDate.now(), "Pendiente");
				Ampliacion am2 = new Ampliacion(pk4, alumnoServicio.findById(32L), asignaturaServicio.findById(11L), LocalDate.now(), "Pendiente");
